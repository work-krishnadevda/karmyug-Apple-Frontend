    ...
    (employeeData, refNumber, currentDate, employeePosition) => {
      ...
      <div class="letter-container">
        ...
        employeeData.fatherName || 'Employee'
            ...
            <p>
                This letter serves as official confirmation that your employment with <span class="highlight">${companyName}</span> from ${dates} to <span class="highlight">${RelievingDate}</span> . We were accepted resignation and wish you all the best in all your future endeavours. <span class="highlight">${totalExperience}</span> worked with us. Last designation was “<strong><span class="highlight-pink">${employeePosition}</span></strong>” and Monthly salary was <span class="highlight">${CtcInNumber}</span>/- rupees (Over time & Conveyance Allowance Excluded). Real Apple Group would like to express our gratitude for your valuable contributions and wish you success in your future career.
            </p>
          ...
          <div class="signature"> 
            ...
            <p><strong><span class="highlight-pink"> A Venture of Real Apple Group</span></strong></p>
