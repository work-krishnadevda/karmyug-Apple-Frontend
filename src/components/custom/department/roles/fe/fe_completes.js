...
export default function FE_Completes() {
        ...
        <div className="action-btn">
          {row.status === 'visit done' ||
            ...
            <>
              ...
              {['visit done', 'pending for draft', 'pending for rc', 'pending for lcto', 'pending for cto', 'submitted to bank'].includes(row.status) && (
  ...
  return (
    <>
      <SingleSubHeader moduleName={'My Completed Visits'} />
