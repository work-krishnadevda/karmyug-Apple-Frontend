...
export default function FE_Pending_Tie_Up() {
    ...
    const fetchData = async () => {
        try {
            ...
            const status = 'pending for tie-up'
            if (performSearch) {
                            ...
                            {row &&
                                ...
                                <CButton
                                    ...
                                    onClick={async () => {
                                        ...
                                        navigate(`/case/${row._id}/edit`, { state: { isTie: true } })
                                    }}
                                >
                                    Start Visit
                                </CButton>
    ...
    return (
        <>
            <SingleSubHeader moduleName={'Tie-up Pending'} />
